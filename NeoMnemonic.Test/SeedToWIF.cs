...
namespace NeoMnemonic.Test
{
    ...
    public class SeedToWIF
    {
        ...
        public void Validation1()
        {
            ...
            var wif = Mnemonic.SeedToWIF(seed, 0);
            Assert.AreEqual(wif, "KwxXjsMj19odxtHyetNFaUzRoynjZErXHCvtjtkfzHetsqNXFEnc");
        }
        [TestMethod]
        public void Validation2()
        {
            var seed = "a497456235972d1be5db9d16ce756b23328ac510b88ae75c4bf8c950cee2c6a8388ca8d2f134e53cf02ce1a5dcca8394763df0de9284167eef0ae7c00f4b2b21".HexToBytes();
            var wif = Mnemonic.SeedToWIF(seed, 60);
            Assert.AreEqual(wif, "L24sRHSMUAD8hoDSRjmkWyWFDBNdAU2SdyDZJhhfvvVxnpGUmbQt");
        }
        [TestMethod]
        public void Validation3()
        {
            var seed = "a497456235972d1be5db9d16ce756b23328ac510b88ae75c4bf8c950cee2c6a8388ca8d2f134e53cf02ce1a5dcca8394763df0de9284167eef0ae7c00f4b2b21".HexToBytes();
            var wif = Mnemonic.SeedToWIF(seed, 888);
        ...
        {
            var seed = "a497456235972d1be5db9d16ce756b23328ac510b88ae75c4bf8c950cee2c6a8388ca8d2f134e53cf02ce1a5dcca8394763df0de9284167eef0ae7c00f4b2b21".HexToBytes();
            var wif = Mnemonic.SeedToWIF(seed, 1024);
            Assert.AreEqual(wif, "KwgdvaE8qTBq1wNKPnjNBWoNn7teCjpkXLUHdBhADXet2Bs8jnEZ");
        }
        [TestMethod]
